...
#define REGION_CLEARED		0	/* Clear Region msg has been processed*/
#define REGION_NEEDSCLEAR	1	/* Clear Region seen, clear the region when can*/
...
void		MwInsertWindow(HWND hwnd, HWND hWndInsertAfter);
