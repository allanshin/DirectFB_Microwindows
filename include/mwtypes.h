...
/* alpha blend src -> dst with alpha from GetAlphaValue, except for transparent color in src*/
#define MWROP_BLENDTRANS			0x26000000L
...
#define MWLF_WEIGHT_EXTRABOLD	800
