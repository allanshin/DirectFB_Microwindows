...
BOOL WINAPI GetTextExtentPoint(HDC hdc,LPCTSTR lpszStr,int cchString,
		LPSIZE lpSize);
BOOL WINAPI GetTextExtentPointW(HDC hdc,LPCTSTR lpszStr,int cchString,
		LPSIZE lpSize);
...
#define OUT_DEVICE_PRECIS           MWLF_TYPE_RASTER
#define OUT_RASTER_PRECIS           MWLF_TYPE_RASTER
